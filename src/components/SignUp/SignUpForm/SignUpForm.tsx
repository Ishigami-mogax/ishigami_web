...
const SignUpForm: FC = (
  ...
  //region Default
  const { boxStyle, dividerStyle, existingAccount, existingAccountLink } =
    styles;
  const {} = props;
  ...
  const handleRegister: (
    ...
    if (confirmPassword !== password)
      throw new Error("The password need to be the same");
    ...
    >
      <Box sx={boxStyle}>
        ...
        <Box component="form" noValidate sx={{ width: "100%" }}>
          ...
          <ButtonGlobal
            image={"ressources/images/google.svg"}
